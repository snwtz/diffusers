...
class AutoencoderKLMultispectralAdapter(AutoencoderKL):
    ...
    def __init__(
        ...
        *,
        ...
        # Filter out all adapter-specific keys before passing to base class
        # This is necessary because the base AutoencoderKL does not accept these arguments
        adapter_keys = {
            "pretrained_model_name_or_path",
            "adapter_channels",
            "adapter_placement",
        ...
        # Only pass valid base VAE config to super().__init__
